...
final class Version20190502172103 extends AbstractMigration {
	public function up ( Schema $schema ): void {
		...
		$this->addSql( 'CREATE TABLE communaute_rnf_sites (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_A317B8315E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB' );
		$this->addSql( 'ALTER TABLE communaute_rnf_usergroups_memberships CHANGE role role VARCHAR(255) DEFAULT NULL, CHANGE notifications_settings notifications_settings JSON DEFAULT NULL' );
